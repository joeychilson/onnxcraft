...
func BERTBaseUncased() Artifact {
	return Artifact{
		...
		Size:       110_848_579,
		Repository: "Xenova/bert-base-uncased",
		Revision:   "ab680a327acc2d9c3bd279ffb1cd43454181f743",
		License:    "Apache-2.0",
	}
}
...
func ResNet50() Artifact {
	return Artifact{
		...
		Size:       102_182_062,
		Repository: "onnx-community/resnet-50-ONNX",
		Revision:   "b6ef686fe842388c9449c7acb7269d02c69bacfb",
		License:    "Apache-2.0",
	}
}
...
func YOLOSSmall() Artifact {
	return Artifact{
		...
		Size:       123_020_648,
		Repository: "Xenova/yolos-small",
		Revision:   "45d2b28b7d2f3ddc80b2543c1520c612602bb9ef",
		License:    "Apache-2.0",
	}
}
